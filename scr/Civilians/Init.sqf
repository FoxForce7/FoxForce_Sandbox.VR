call compile preprocessFileLineNumbers "scr\Civilians\Common\Common.sqf";
call compile preprocessFileLineNumbers "scr\Civilians\Common\Debug.sqf";
...
if (isServer) then {
	call compile preprocessFileLineNumbers "scr\Civilians\Server\ServerFunctions.sqf";
	call compile preprocessFileLineNumbers "scr\Civilians\ConfigAndStart.sqf";
};
